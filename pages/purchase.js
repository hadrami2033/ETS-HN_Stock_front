...
const Purchase = (props) => {
  const {products=[], title, handleClosePurchase } = props;
  ...
  const onChangeQuantity = (e, el, index) => {
    const { value } = e.target
    let temp = orders;
    const obj = {...el, quantite: value, prixTotal: el.prixAchat*value}
    temp[index] = obj;
  ...
  return (
      ...
      {step == 2 &&
        ...
        <TableRow
          ...
          <TableCell align="left">{pounds.format(e.prixAchat)} CFA</TableCell>
