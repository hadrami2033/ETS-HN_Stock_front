...
const Commissions = () => {
  ...
  return (
    <BaseCard titleColor={"secondary"} title={"Commissions de versement"}>
            ...
            <Box sx={{ width: '100%', marginTop:'35px', marginLeft: '15px', whiteSpace: "nowrap", overflowX: 'auto', overflowY: 'hidden'}}>
                  ...
                  <Box style={{width:'100%'}}>
                    {commissionsversement.length > 0 ?
                        ...
                        >
                            <EnhancedTableHead
                                rowCount={commissionsversement.length}
                                headCells={headCellsOpperation}
                                headerBG="#1A7795"
                                txtColor="#DCDCDC"
                            />
                            <TableBody>
                                {commissionsversement
                                .map((row, index) => {
                                    return (
                                    <TableRow
                                        hover
